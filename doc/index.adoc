...
You need Java 11+ in order to proceed.
If you don't have any, or your version is too old (less than 11), proceed to https://jdk.java.net/[], download and install appropriate version.
    ...
    charpad {
        ...
        outputs {
            ...
            tiles {
                ...
                interleaver {
                    output = file("src/levels/level1/tiles.bin")
                }
            ...
            tileColours {
                output = file("src/levels/level1/colors.bin")
            }
            ...
            map {
                ...
                right = 260
                interleaver {
                    output = file("src/levels/level1/map-2.bin")
                }
                interleaver {
                }
            }
            map {
                left = 260
                interleaver {
                    output = file("src/levels/level1/map-3.bin")
                }
                interleaver {
                }
            }
