...
* `Test`: Use INJECT_TO_RAM instead of VIRTUAL_FS when running Vice and 64spec; with VIRTUAL_FS and Vice 3.4+ there was ?DEVICE NOT FOUND error thrown in Vice and test execution hanged.
