...
| [MET-0017](MET-0017_branch-pr-ship-flow.md) | 2026-07-16 | Maciej Małecki | Strengthen plan and execute skills so an accepted plan gets a feature branch and execution ships work in order (commit → push → PR → issue sync → issue close) before closing the issue |
| [MET-0018](MET-0018_add-release-skill.md) | 2026-07-18 | Maciej Małecki | Replace the release-notes-only /release command with a full interactive release skill (version choice, release notes, CHANGES.adoc, merge develop→master, semver tag to trigger Gradle Plugin Portal publish) |
| [MET-0019](MET-0019_remove-fixme-command.md) | 2026-07-18 | Maciej Małecki | Remove the /fixme command and its generator metaprompt — tied to the abandoned .ai/ legacy plan system; error handling now lives in the execute skill |
| [MET-0020](MET-0020_challenge-at-acceptance.md) | 2026-07-19 | Maciej Małecki | Move the adversarial-challenge offer from execute-time to plan acceptance, recording the outcome in a new **Challenge** plan header field |
| [MET-0021](MET-0021_plan-xyz-in-progress.md) | 2026-07-19 | Maciej Małecki | Add `plan #xyz` issue-driven shorthand to the plan skill and offer to move the linked issue to In Progress on the c64lib project board when planning starts |
